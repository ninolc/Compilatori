...
static yyconst short int yy_accept[43] =
    {   0,
        0,    0,    0,    0,    8,    8,    0,    0,   10,   10,
       15,   13,   14,    1,    6,    5,    6,    6,    6,    6,
        8,    7,    9,    9,   10,   12,   11,    3,    3,    1,
        2,    6,    6,    6,    6,    6,    8,    9,   10,    4,
        3,    0
    } ;
...
static yyconst short int yy_base[48] =
    {   0,
        0,    5,   10,    0,   21,    0,   32,    0,   35,    0,
       53,   78,   78,   45,   48,   78,   45,   43,   41,   21,
       19,   78,   78,    0,    0,   78,   78,    0,   55,   57,
       59,   24,   21,   19,   17,   15,   13,    0,    0,    0,
        0,   78,   70,   72,    1,    0,   74
    } ;

static yyconst short int yy_def[48] =
    {   0,
       43,   43,   42,    3,   43,    5,   43,    7,   42,    9,
       42,   42,   42,   44,   42,   42,   42,   42,   42,   42,
       42,   42,   42,   45,   46,   42,   42,   47,   47,   44,
       47,   42,   42,   42,   42,   42,   42,   45,   46,   47,
       29,    0,   42,   42,   42,   42,   42
    } ;

static yyconst short int yy_nxt[90] =
    {   0,
       12,   39,   38,   42,   14,   12,   42,   42,   42,   14,
       12,   13,   13,   15,   16,   17,   18,   19,   20,   13,
       13,   12,   37,   36,   35,   34,   33,   32,   37,   36,
       21,   22,   12,   23,   24,   12,   25,   25,   26,   26,
       26,   26,   26,   26,   27,   27,   28,   29,   35,   34,
       33,   32,   42,   42,   31,   31,   41,   41,   40,   40,
       42,   42,   42,   42,   42,   42,   40,   40,   31,   31,
       13,   13,   13,   30,   30,   40,   40,   11,   42,   42,
       42,   42,   42,   42,   42,   42,   42,   42,   42
    } ;

static yyconst short int yy_chk[90] =
    {   0,
        1,   46,   45,    0,    1,    2,    0,    0,    0,    2,
        3,    3,    3,    3,    3,    3,    3,    3,    3,    3,
        3,    5,   37,   36,   35,   34,   33,   32,   21,   20,
        5,    5,    7,    7,    7,    9,    9,    9,    9,    9,
        9,    9,    9,    9,    9,    9,   14,   14,   19,   18,
       17,   15,   11,    0,   14,   14,   29,   29,   30,   30,
        0,    0,    0,    0,    0,    0,   30,   30,   31,   31,
       43,   43,   43,   44,   44,   47,   47,   42,   42,   42,
       42,   42,   42,   42,   42,   42,   42,   42,   42
    } ;
...
YY_DO_BEFORE_ACTION; /* set up yytext again */
YY_RULE_SETUP
#line 56 "Esercizio.fl"
{fprintf(yyout,"%s",yytext);BEGIN(VOCALI);primo++;}
	YY_BREAK
case 2:
*yy_cp = yy_hold_char; /* undo effects of setting up yytext */
yy_c_buf_p = yy_cp = yy_bp + 1;
YY_DO_BEFORE_ACTION; /* set up yytext again */
YY_RULE_SETUP
#line 57 "Esercizio.fl"
{fprintf(yyout,"%s",yytext);BEGIN(VOCALICONS);secondo++;}
	YY_BREAK
case 3:
*yy_cp = yy_hold_char; /* undo effects of setting up yytext */
yy_c_buf_p = yy_cp = yy_bp + 1;
YY_DO_BEFORE_ACTION; /* set up yytext again */
YY_RULE_SETUP
#line 58 "Esercizio.fl"
{fprintf(yyout,"%s",yytext);BEGIN(NUMERI);terzo++;}
	YY_BREAK
case 4:
*yy_cp = yy_hold_char; /* undo effects of setting up yytext */
yy_c_buf_p = yy_cp = yy_bp + 1;
YY_DO_BEFORE_ACTION; /* set up yytext again */
YY_RULE_SETUP
#line 59 "Esercizio.fl"
{fprintf(yyout,"%s",yytext);BEGIN(ALFANUM);quarto++;}
	YY_BREAK
case 5:
YY_RULE_SETUP
...
{fprintf(yyout,"%c%d",tolower(yytext[0]),yyleng);}
	YY_BREAK
case 7:
YY_RULE_SETUP
...
case 11:
YY_RULE_SETUP
#line 115 "Esercizio.fl"
fprintf(yyout,"%c",toupper(yytext[0]));
	YY_BREAK
case 12:
YY_RULE_SETUP
#line 117 "Esercizio.fl"
fprintf(yyout,"%c",tolower(yytext[0]));
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 119 "Esercizio.fl"
{fprintf(yyout,"%s",yytext);BEGIN(0);}
	YY_BREAK
case 14:
YY_RULE_SETUP
#line 121 "Esercizio.fl"
ECHO;
	YY_BREAK
#line 802 "lex.yy.c"
case YY_STATE_EOF(INITIAL):
case YY_STATE_EOF(VOCALI):
case YY_STATE_EOF(VOCALICONS):
case YY_STATE_EOF(NUMERI):
case YY_STATE_EOF(ALFANUM):
	yyterminate();
